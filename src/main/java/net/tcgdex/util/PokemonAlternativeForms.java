...
public final class PokemonAlternativeForms {
        ...
        public static boolean matchesForm(String englishName,
                ...
                return matchesAnyAlias(buildHaystack(englishName, frenchName, storedFormLabel, derivedVariantLabel),
                                form);
        }
        ...
        private static Map<Integer, List<PokemonAlternativeForm>> buildForms() {
                ...
                forms.put(351, List.of(
                                form(351, 1, "Castform Rain", "Morpheo Pluie", "Pluie",
                                                "castform rain", "rain castform", "rainy form castform",
                                                "morpheo pluie"),
                                form(351, 2, "Castform Sun", "Morpheo Soleil", "Soleil",
                                                "castform sun", "sun castform", "sunny form castform",
                                                "morpheo soleil"),
                                form(351, 3, "Castform Snow", "Morpheo Neige", "Neige",
                                                "castform snow", "castform ice", "snow castform", "snowy form castform",
                                                "morpheo neige")));

                forms.put(386, List.of(
                                form(386, 1, "Deoxys Attack", "Deoxys Forme Attaque", "Attaque",
                                                "deoxys attack", "deoxys attack forme", "attack forme deoxys",
                                                "deoxys forme attaque"),
                                form(386, 2, "Deoxys Speed", "Deoxys Forme Vitesse", "Vitesse",
                                                "deoxys speed", "deoxys speed forme", "speed forme deoxys",
                                                "deoxys forme vitesse"),
                                form(386, 3, "Deoxys Defense", "Deoxys Forme Defense", "Defense",
                                                "deoxys defense", "deoxys defense forme", "defense forme deoxys",
                                                "deoxys forme defense")));
                ...
                forms.put(550, List.of(
                                ...
                                regionalForm(550, 3, RegionalForm.HISUI, "White-Striped Basculin", "Bargantua Blanc",
                                                "Blanc d'Hisui",
                                                "white-striped basculin", "basculin white", "bargantua blanc",
                                                "bargantua de hisui")));

                forms.put(555, List.of(
                                form(555, 1, "Darmanitan Zen", "Darumacho Mode Transe", "Transe",
                                                "darmanitan zen", "zen darmanitan", "zen mode darmanitan",
                                                "darumacho mode transe", "darumacho transe"),
                                regionalForm(555, 2, RegionalForm.GALAR, "Galarian Darmanitan Zen",
                                                "Darumacho de Galar Mode Transe", "Transe de Galar",
                                                "galarian darmanitan zen", "galarian zen darmanitan",
                                                "galarian darmanitan zen mode", "galarian zen mode darmanitan",
                ...
                forms.put(642, List.of(
                                form(642, 1, "Thundurus Totem", "Fulguris Forme Totemique", "Totemique",
                                                "thundurus totem", "therian forme thundurus",
                                                "fulguris forme totemique")));

                forms.put(645, List.of(
                                form(645, 1, "Landorus Totem", "Demeteros Forme Totemique", "Totemique",
                                                "landorus totem", "therian forme landorus",
                                                "demeteros forme totemique")));
                ...
                forms.put(648, List.of(
                                form(648, 1, "Meloetta Pirouette", "Meloetta Pirouette", "Pirouette",
                                                ...
                                                "meloetta forme danse")));

                forms.put(678, List.of(
                                defaultForm(678, 1, "Meowstic Male", "Mystigrix Male", "Male",
                                                "meowstic male", "mystigrix male", "male meowstic", "male mystigrix",
                                                "meowstic m"),
                                form(678, 2, "Meowstic Female", "Mystigrix Femelle", "Femelle",
                                                "meowstic female", "mystigrix femelle", "female meowstic",
                                                "female mystigrix", "meowstic f")));
                ...
                forms.put(741, List.of(
                                defaultForm(741, 1, "Oricorio Pompom", "Plumeline Style Pom-Pom", "Pom-Pom",
                                                "oricorio pompom", "oricorio pom-pom", "pom-pom style oricorio",
                                                "plumeline style pom-pom"),
                                form(741, 2, "Oricorio Flamenco", "Plumeline Style Flamenco", "Flamenco",
                                                "oricorio flamenco", "baile style oricorio",
                ...
                forms.put(745, List.of(
                                ...
                                form(745, 3, "Lycanroc Dawn", "Lougaroc Forme Crepusculaire", "Crepusculaire",
                                                "lycanroc dawn", "dusk form lycanroc",
                                                "lougaroc forme crepusculaire")));

                forms.put(746, List.of(
                                form(746, 1, "Wishiwashi Bench", "Froussardine Forme Banc", "Banc",
                                                "wishiwashi bench", "wishiwashi school", "froussardine forme banc",
                                                "froussardine banc")));
                ...
                forms.put(898, List.of(
                                ...
                                form(898, 2, "Calyrex Ghost Rider", "Sylveroy, le Cavalier d'Effroi",
                                                "Cavalier d'Effroi",
                                                "calyrex ghost rider", "shadow rider calyrex",
                                                "sylveroy cavalier d effroi")));

                forms.put(905, List.of(
                                form(905, 1, "Enamorus Totem", "Amovenus Forme Totemique", "Totemique",
                                                "enamorus totem", "therian forme enamorus",
                                                "amovenus forme totemique")));
                ...
                forms.put(3, List.of(
                                ...
                                gigantamaxForm(3, 2, "Gigantamax Venusaur", "Florizarre Gigamax", "Gigamax",
                                                "gigantamax venusaur", "venusaur gmax", "venusaur vmax",
                                                "florizarre gigamax", "florizarre vmax")));
                ...
                forms.put(6, List.of(
                                ...
                                gigantamaxForm(6, 3, "Gigantamax Charizard", "Dracaufeu Gigamax", "Gigamax",
                                                "gigantamax charizard", "charizard gmax", "charizard vmax",
                                                "dracaufeu gigamax", "dracaufeu vmax")));
                ...
                forms.put(9, List.of(
                                ...
                                gigantamaxForm(9, 2, "Gigantamax Blastoise", "Tortank Gigamax", "Gigamax",
                                                "gigantamax blastoise", "blastoise gmax", "blastoise vmax",
                                                "tortank gigamax", "tortank vmax")));

                forms.put(12, List.of(
                                gigantamaxForm(12, 1, "Gigantamax Butterfree", "Papilusion Gigamax", "Gigamax",
                                                "gigantamax butterfree", "butterfree gmax", "butterfree vmax",
                                                "papilusion gigamax", "papilusion vmax")));
                ...
                forms.put(25, List.of(
                                gigantamaxForm(25, 1, "Gigantamax Pikachu", "Pikachu Gigamax", "Gigamax",
                                                "gigantamax pikachu", "pikachu gmax", "pikachu vmax",
                                                "pikachu gigamax")));

                forms.put(52, List.of(
                                gigantamaxForm(52, 1, "Gigantamax Meowth", "Miaouss Gigamax", "Gigamax",
                                                "gigantamax meowth", "meowth gmax", "miaouss gigamax",
                                                "miaouss gmax")));
                ...
                forms.put(68, List.of(
                                gigantamaxForm(68, 1, "Gigantamax Machamp", "Mackogneur Gigamax", "Gigamax",
                                                "gigantamax machamp", "machamp gmax", "machamp vmax",
                                                "mackogneur gigamax", "mackogneur vmax")));
                ...
                forms.put(94, List.of(
                                ...
                                gigantamaxForm(94, 2, "Gigantamax Gengar", "Ectoplasma Gigamax", "Gigamax",
                                                "gigantamax gengar", "gengar gmax", "gengar vmax", "ectoplasma gigamax",
                                                "ectoplasma vmax")));

                forms.put(99, List.of(
                                gigantamaxForm(99, 1, "Gigantamax Kingler", "Krabboss Gigamax", "Gigamax",
                                                "gigantamax kingler", "kingler gmax", "kingler vmax",
                                                "krabboss gigamax", "krabboss vmax")));
                ...
                forms.put(131, List.of(
                                gigantamaxForm(131, 1, "Gigantamax Lapras", "Lokhlass Gigamax", "Gigamax",
                                                "gigantamax lapras", "lapras gmax", "lapras vmax", "lokhlass gigamax",
                                                "lokhlass vmax")));

                forms.put(133, List.of(
                                gigantamaxForm(133, 1, "Gigantamax Eevee", "Evoli Gigamax", "Gigamax",
                                                "gigantamax eevee", "eevee gmax", "eevee vmax", "evoli gigamax",
                                                "evoli vmax")));
                ...
                forms.put(143, List.of(
                                gigantamaxForm(143, 1, "Gigantamax Snorlax", "Ronflex Gigamax", "Gigamax",
                                                "gigantamax snorlax", "snorlax gmax", "snorlax vmax", "ronflex gigamax",
                                                "ronflex vmax")));
                ...
                forms.put(569, List.of(
                                gigantamaxForm(569, 1, "Gigantamax Garbodor", "Miasmax Gigamax", "Gigamax",
                                                "gigantamax garbodor", "garbodor gmax", "garbodor vmax",
                                                "miasmax gigamax", "miasmax vmax")));
                ...
                forms.put(892, List.of(
                                ...
                                gigantamaxForm(892, 11, "Gigantamax Urshifu Final Blow", "Shifours Gigamax Poing Final",
                                                "Gigamax Poing Final",
                                                "gigantamax urshifu single strike", "single strike urshifu vmax",
                                                "urshifu final blow vmax", "shifours gigamax poing final"),
                                gigantamaxForm(892, 12, "Gigantamax Urshifu Rapid Strike",
                                                "Shifours Gigamax Mille Poings", "Gigamax Mille Poings",
                                                "gigantamax urshifu rapid strike", "rapid strike urshifu vmax",
                                                "urshifu rapid strike vmax", "shifours gigamax mille poings")));
                ...
                forms.put(668, List.of(
                                megaForm(668, 1, "Mega Pyroar", "Méga-Némélios", "Mega",
                ...
                forms.put(445, List.of(
                                ...
                                megaForm(445, 2, "Mega Garchomp Z", "Méga-Carchacrok Z", "Mega Z",
                                                "mega garchomp z", "garchomp z", "mega carchacrok z", "carchacrok z",
                                                "méga carchacrok z")));
                ...
                forms.put(128, List.of(
                                regionalForm(128, 1, RegionalForm.PALDEA, "Paldean Tauros Fire",
                                                "Tauros de Paldea Race Flamboyante", "Feu",
                                                "paldean tauros fire", "paldean tauros blaze breed",
                                                "tauros de paldea feu",
                                                "tauros de paldea race flamboyante", "tauros de paldea type feu"),
                                regionalForm(128, 2, RegionalForm.PALDEA, "Paldean Tauros Water",
                                                "Tauros de Paldea Race Aquatique", "Eau",
                                                "paldean tauros water", "paldean tauros aqua breed",
                                                "tauros de paldea eau",
